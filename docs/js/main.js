...
},{"./createStore":19,"./utils/warning":21,"_process":13,"lodash/isPlainObject":12}],18:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":12,"symbol-observable":23}],20:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":15,"./bindActionCreators":16,"./combineReducers":17,"./compose":18,"./createStore":19,"./utils/warning":21,"_process":13}],21:[function(require,module,exports){
'use strict';
...
},{"_process":13,"dot-prop":1}],23:[function(require,module,exports){
...
function _parseContent(data, path) {
  var directory = path === '' ? path : path;
  var result = void 0;
  if (Array.isArray(data)) {
    result = new _types.Filelist(data, directory);
  } else if (data.type === 'file') {
    result = new _types.File(data);
  } else {
    result = new _types.PathError(data);
  }
  return result;
}
...
var shouldFetchContent = function shouldFetchContent(state, path) {
  var content = state.contentByPath[path];
  if (!content) {
    return true;
  }
...
var _filestore = require('./filestore.js');
...
var Filelist = exports.Filelist = function Filelist(fileArray) {
  var directoryName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var File = exports.File = function File(file) {
...
var PathError = exports.PathError = function PathError(result) {
